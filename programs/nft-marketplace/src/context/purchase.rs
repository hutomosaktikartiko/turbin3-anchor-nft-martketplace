...
pub struct Purchase<'info> {
    #[account(mut)]
    pub taker: Signer<'info>, // buyer must sign transaction

    #[account(mut)]
    pub maker: SystemAccount<'info>, // seller account
    ...
    #[account(
        init_if_needed, // if token account not found, create it
        payer = taker,
        associated_token::mint = maker_mint,
        associated_token::authority = taker,
    )]
    pub taker_ata: InterfaceAccount<'info, TokenAccount>, // buyer token account
    ...
    pub taker_ata_reward: InterfaceAccount<'info, TokenAccount>, // buyer token account
